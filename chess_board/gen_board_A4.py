...
def gen_chess_board_A4(save_folder:str, chessboard_params:List[Tuple[int, int, float]], dpi:int, gap_cm:float,
    ...
    for idx, (rows, cols, square_size_cm) in enumerate(chessboard_params):
        ...
        image_save_path = os.path.join(save_folder, f'chess_board_A4_{(idx + 1)}.png')
...
if __name__ == "__main__":
    ...
    output_pdf = os.path.join(save_folder, 'chess_board_A4.pdf')
    ...
    gen_chess_board_A4(save_folder, chessboard_params, dpi, gap_cm, margins_cm, output_pdf)
